 ...
 * @author leonid.
 */
public class ResultBigOpenView {
    ...
    private void prepare() {
        ...
        evaluation.setResultElement( getResultBigOpen() );
    }

    public ResultBigOpen getResultBigOpen() {
        return current.getElements() != null && current.getElements().size() > 0 ? (ResultBigOpen) current.getElements().get( 0 ) : null;
    }
